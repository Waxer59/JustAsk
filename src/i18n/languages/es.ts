export default {
  ...
  // DASHBOARD CREATE SURVEY GENERAL
  'dashboard.createSurvey.general': 'General',
  'dashboard.createSurvey.general.title': 'Título',
  'dashboard.createSurvey.general.title.placeholder': 'Encuesta de estudiantes',
  'dashboard.createSurvey.general.language': 'Idioma',
  'dashboard.createSurvey.general.language.placeholder': 'Selecciona un idioma',
  ...
  'dashboard.createSurvey.offer.additionalInformation': 'Información adicional',
  'dashboard.createSurvey.offer.additionalInformation.description':
    'Especifica cualquier información adicional',

  // DASHBOARD CREATE SURVEY QUESTIONS
  ...
  // DASHBOARD CREATE SURVEY CATEGORIZATION
  ...
  'dashboard.createSurvey.categorization.category.add.description':
    'Agrega una categoría para saber en qué nivel se encuentran tus candidatos.',

  // DASHBOARD CREATE SURVEY DOCUMENTS
  ...
  'email.magicLink.footer.warn': 'Si no lo has solicitado, ignora este email.',
