...
export const ui = {
  en: {
    ...
    'callToAction2.title': 'What are you waiting for?',
    callToAction2: 'Get started now!',
    ...
    'steps.3.title': '3. Final adjustments',
    'steps.3.desc':
      'Personalize the interview simulation according to your preferences to feel completely prepared.',
    'steps.4.title': '4. Conduct the interview',
    'steps.4.desc':
      'Practice with our AI and receive detailed feedback along with a score at the end.',
    'steps.5.title': '5. Accelerate your career!',
    'steps.5.desc':
      'Develop your skills and take the next step toward your new job.',
    'footer.text': 'Made by',
    'stepper.step.1': 'Offer',
    'stepper.step.2': 'Documents',
    'stepper.step.3': 'Configure',
    'stepper.step.4': 'Ready!',
    'step1.tab.1': 'Search',
    'step1.tab.2': 'Manual',
    'step1.offerLink': 'Offer link',
    'step1.selectOffer': 'Select offer',
    'step1.offerTitle': 'Title',
    'step1.offerDescription': 'Description',
    'step1.offerTitle.description': 'Title of the offer',
    'step1.offerDescription.description': 'Description of the offer',
    'step2.title': 'Optional',
    'step3.interviewStyle': 'Interview Style',
    'step3.interviewStyle.description': 'What style of interview do you want?',
    'step3.interviewStyle.placeholder': 'Technical',
    'step3.simulation': 'Define the Simulation',
    'step3.simulation.option.1': "Let's simulate an interview!",
    'step3.simulation.option.2': 'I just want the interview questions',
    'step3.additionalInfo': 'Want to add something else?',
    'step3.additionalInfo.description': 'Additional Information',
    'step3.start': 'Start!',
    'controlButton.next': 'Next',
    'controlButton.previous': 'Previous',
    'questions.loading': 'We are creating the questions...',
    'questions.error': 'Error loading the questions',
    'feedback.loading': 'We are rating the answers',
  ...
  es: {
    ...
    'callToAction2.title': '¿A qué esperas?',
    callToAction2: '¡Empieza ya!',
    ...
    'steps.3.title': '3. Ajustes finales',
    'steps.3.desc':
      'Personaliza la simulación de entrevista según tus preferencias para sentirte completamente preparado.',
    'steps.4.title': '4. Realiza la entrevista',
    'steps.4.desc':
      'Practica con nuestra IA y recibe un feedback detallado junto con un puntaje al finalizar.',
    'steps.5.title': '5. ¡Acelera tu carrera!',
    'steps.5.desc':
      'Desarrolla tus habilidades y da el siguiente paso hacia tu nuevo trabajo.',
    'footer.text': 'Hecho por',
    'stepper.step.1': 'Oferta',
    'stepper.step.2': 'Documentos',
    'stepper.step.3': 'Configura',
    'stepper.step.4': '¡Listo!',
    'step1.tab.1': 'Buqueda',
    'step1.tab.2': 'Manual',
    'step1.offerLink': 'Enlace a la oferta',
    'step1.selectOffer': 'Seleccionar oferta',
    'step1.offerTitle': 'Titulo',
    'step1.offerDescription': 'Descripcion',
    'step1.offerTitle.description': 'Titulo de la oferta',
    'step1.offerDescription.description': 'Descripción de la oferta',
    'step2.title': 'Opcional',
    'step3.interviewStyle': 'Estilo de la entrevista',
    'step3.interviewStyle.description': '¿Qué estilo de entrevista quieres?',
    'step3.interviewStyle.placeholder': 'Técnica',
    'step3.simulation': 'Define la simulación',
    'step3.simulation.option.1': '¡Simulemos una entrevista!',
    'step3.simulation.option.2': 'Solo quiero las preguntas de la entrevista',
    'step3.additionalInfo': '¿Quieres añadir algo más!',
    'step3.additionalInfo.description': 'Información adicional',
    'step3.start': '¡Empezar!',
    'controlButton.next': 'Siguiente',
    'controlButton.previous': 'Anterior',
    'questions.loading': 'Estamos pensando las preguntas...',
    'questions.error': 'Error al cargar las preguntas',
    'feedback.loading': 'Estamos calificando las respuestas',
